...
export function Header() {
  return (
    <header id="hero" className="relative flex h-screen flex-col items-center justify-center text-center">
      ...
      <a href="#content" aria-label="Scroll to content" className="absolute bottom-10 left-1/2 -translate-x-1/2 group animate-in fade-in duration-1000 delay-1000 fill-mode-both">
